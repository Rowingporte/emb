...
4. Architecture Technique. Couche Matérielle et Device Tree

Le capteur HC-SR04 est interfacé avec la STM32MP1 via les connecteurs Arduino : 
- TRIGGER : GPIO PA12 (Configuré en sortie).
- ECHO : GPIO PA11 (Configuré en entrée avec support d'interruption).
...
Traitement du Bruit : Calcul de la moyenne et de l'écart-type sur les 10 derniers échantillons.
...
Créer le nœud de communication :
...
Lancement du Bridge de données (Cible)
